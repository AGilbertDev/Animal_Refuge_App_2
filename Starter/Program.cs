...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            string[] searchWords = dogCharacteristic.Split(",");
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    // Search individual word and report results
                    ...
                    foreach (string word in searchWords)
                    {
                        for (int j = 3; j > -1; j--)
                        {
                            ...
                            {
                                Console.Write($"\rsearching our dog {ourAnimals[i, 3]} for {word.Trim()} {icon}  {j}");
                                Thread.Sleep(120);
                            }
                        ...
                        if (dogDescription.Contains(word.Trim()))
                        {
                            ...
                            Console.WriteLine($"\rOur dog {ourAnimals[i, 3]} is a match for {word.Trim()}");
